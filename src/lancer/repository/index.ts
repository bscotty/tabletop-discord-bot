import {LancerRepository, LicenseData} from "./lancerRepository";
...
export default function getRepository(): LancerRepository {
    if (!_repository) {
...
class RepositoryImpl implements LancerRepository {
